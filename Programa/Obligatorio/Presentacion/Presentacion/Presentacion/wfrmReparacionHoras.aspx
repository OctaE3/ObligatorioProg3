<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="wfrmReparacionHoras.aspx.cs" Inherits="Presentacion.Presentacion.wfrmReparacionHoras" %>
        ...
        <div class="row">
            <div class="row" style="background-image: url(https://fondosmil.com/fondo/25803.jpg); border-radius: 5px; margin-top: 1%">
                <div class="col-sm-6">
                    ...
                    <h3 style="text-align: center; margin-top: 1%; color:white">Gestion Reparacion Horas</h3>
                    <div style="">
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            <label for="exampleDDLVehiculo" style="color:white" class="form-label">Horas</label>
                            <asp:TextBox ID="txtHoras" TextMode="Phone" class="form-control" runat="server"></asp:TextBox>
                        </div>
                        <div class="mb-3">
                            <label for="exampleInputFchEntrada" style="color:white" class="form-label">Costo por Hora</label>
                ...
                <div class="col-sm-6">
                    ...
                    <div class="col-sm-12" style="margin-top: 1%; margin-bottom: 2%">
                        <h3 style="text-align: center; color:white">Lista de Reparacion Horas</h3>
                        <asp:ListBox ID="lstReparacionHoras" class="form-control" runat="server" OnSelectedIndexChanged="lstReparacionRepuesto_Click" AutoPostBack="true" Height="260px" Style="border: 2px solid black"></asp:ListBox>
                    </div>
                </div>
            </div>
        </div>
