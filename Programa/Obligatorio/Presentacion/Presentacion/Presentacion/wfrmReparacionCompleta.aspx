<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="wfrmReparacionCompleta.aspx.cs" Inherits="Presentacion.Presentacion.wfrmReparacionCompleta" %>
    ...
    <div class="container" style="margin-top: 2%; margin-bottom: 2%">
        <div class="row" style="background-image: url(https://fondosmil.com/fondo/25803.jpg); border-radius: 5px; margin-top: 1%">
            <div class="col-sm-6">
                <div style="display: flex; justify-content: center; align-items: center">
                    ...
                    <div class="mOtra mt-2" id="visibilidad3" runat="server" style="position: absolute;">
                        ...
                        <div class="alert alert-danger" role="alert" style="height: 55px">
                            ...
                            <div style="float: left;">
                                Esta Reparacion se encuentra asignada no puede eliminarse.
                            </div>
                        </div>
                    </div>
                ...
                <h3 style="text-align: center; margin-top: 1%; color:white">Gestion Reparaciones Completas</h3>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    <label for="exampleDDLMecanico" style="color:white" class="form-label">Mecanico</label>
                    <asp:DropDownList ID="ddlMecanico" class="form-control" runat="server" />
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    <label for="exampleInputFchEntrada" style="color:white" class="form-label">Fecha De Ingreso del Vehiculo</label>
                    <asp:TextBox TextMode="Date" class="form-control" ID="txtFchEntrada" runat="server" />
                </div>
                <div class="mb-3">
                    <label for="exampleInputFchSalida" style="color:white" class="form-label">Fecha De Salida del Vehiculo</label>
                    <asp:TextBox TextMode="Date" class="form-control" ID="txtFchSalida" runat="server" />
                </div>
                <div class="mb-3">
                    <label for="exampleInputRepDscEntrada" style="color:white" class="form-label">Descripcion del Problema</label>
                    <asp:TextBox TextMode="multiline" class="form-control" ID="txtRepDscEntrada" runat="server" Rows="3" />
                </div>
                <div class="mb-3">
                    <label for="exampleInputRepDscEntrada" style="color:white" class="form-label">Descripcion de la solucion al problema</label>
                    <asp:TextBox TextMode="multiline" class="form-control" ID="txtRepDscSalida" runat="server" Rows="3" />
                </div>
                <div class="mb-3">
                    <label for="exampleInputKmsEntrada" style="color:white" class="form-label">Kms del Vehiculo</label>
                    <asp:TextBox TextMode="Number" class="form-control" ID="txtKmsEntrada" runat="server" />
                </div>
            ...
            <div class="col-sm-6">
                <div class="col-sm-12">
                    <div style="margin-top: 5%">
                        <h3 style="text-align: center; color:white">Lista de Reparacion Pendientes</h3>
                        <asp:ListBox ID="lstReparacionPendiente" class="form-control" runat="server" OnSelectedIndexChanged="lstReparacionPendiente_Click" AutoPostBack="true" Style="height: 400px; border: 2px solid black"></asp:ListBox>
                    </div>
                </div>
                <div class="col-sm-12" style="margin-top: 1%; margin-bottom: 2%">
                    <h3 style="text-align: center; color:white">Lista de Reparacion Completas</h3>
                    <asp:ListBox ID="lstReparacionCompleta" class="form-control" runat="server" OnSelectedIndexChanged="lstReparacionCompleta_Click" AutoPostBack="true" Height="400px" Style="border: 2px solid black"></asp:ListBox>
                </div>
            </div>
        </div>
    </div>
