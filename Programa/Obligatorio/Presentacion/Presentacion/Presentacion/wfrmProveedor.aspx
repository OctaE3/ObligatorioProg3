<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="wfrmProveedor.aspx.cs" Inherits="Presentacion.Presentacion.wfrmProveedor" %>
    ...
    <div class="container" style="margin-top: 10%">
        <div class="row">
            ...
            <div class="col-sm-8" style="background-image: url(https://fondosmil.com/fondo/25803.jpg); border-radius: 5px; margin-top: 1%">
                <div style="display: flex; justify-content: center; align-items: center">
                    ...
                    <div class="mOtra mt-2" id="visibilidad3" runat="server" style="position: absolute;">
                        ...
                        <div class="alert alert-danger" role="alert" style="height: 55px">
                            ...
                            <div style="float: left;">
                                Este Proveedor se encuentra asignado no puede eliminarse.
                            </div>
                        </div>
                    </div>               
                ...
                <h3 style="text-align: center; margin-top: 1%; color: white">Gestión Proveedor</h3>
                <div class="mb-3">
                    <label for="exampleInputProveedorCod" style="color:white;" class="form-label">Codigo del Proveedor</label>
                    <asp:TextBox TextMode="Number" class="form-control" ID="txtProveedorCod" runat="server" Enabled="false" Style="display: block; width: 100%; padding: 0.375rem 0.75rem; font-size: 1rem; font-weight: 400; line-height: 1.5; color: #212529; background-color: #CBCBCB; background-clip: padding-box; border: 1px solid #ced4da; appearance: none; border-radius: 0.375rem; transition: border-color .15s ease-in-out,box-shadow .15s ease-in-out;" />
                </div>
                <div class="mb-3">
                    <label for="exampleInputProveedorNom" style="color:white;" class="form-label">Nombre del Proveedor</label>
                    <asp:TextBox TextMode="SingleLine" class="form-control" ID="txtProveedorNom" runat="server" />
                </div>
                <div class="mb-3">
                    <label for="exampleInputProveedorRut" style="color:white;" class="form-label">Codigo RUT del Proveedor</label>
                    <asp:TextBox TextMode="Number" class="form-control" ID="txtProveedorRut" runat="server" Rows="3" />
                </div>
                <asp:RegularExpressionValidator
                    ID="RegularExpressionValidatorRut"
                    runat="server"
                    ControlToValidate="txtProveedorRut"
                    ErrorMessage="Ingrese un RUT valido"
                    ForeColor="White"
                ...
                <div class="mb-3">
                    <asp:ListBox ID="lstProveedor" class="form-control" runat="server" OnSelectedIndexChanged="lstProveedor_Click" AutoPostBack="True"></asp:ListBox>
                </div>
            </div>
            <div class="col-sm-2"></div>
        </div>
