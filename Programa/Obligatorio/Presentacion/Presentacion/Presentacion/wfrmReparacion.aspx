<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="wfrmReparacion.aspx.cs" Inherits="Presentacion.Presentacion.wfrmReparacion" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div class="container" style="margin-top:2%; margin-bottom: 2%">
        <div class="row">
            ...
            <div class="col-sm-3" style="visibility:hidden"><asp:TextBox ID="txtId" runat="server"/></div>
        </div>
        <div class="row" style="background-image: url(https://fondosmil.com/fondo/25803.jpg); border-radius: 5px; margin-top: 1%">
            <div class="col-sm-6">
                ...
                <h3 style="text-align: center; margin-top: 1%; color:white">Gestion Reparaciones Pendientes</h3>
                <div class="mb-3">
            ...
            <div class="col-sm-6">
                <div class="col-sm-12">
                    <div>
                        <h3 style="text-align: center; color:white">Reservas</h3>
                        <asp:ListBox ID="lstReserva" class="form-control" runat="server" OnSelectedIndexChanged="lstReservas_Click" AutoPostBack="true" Style="height: 310px; border: 2px solid black"></asp:ListBox>
                        <asp:Button ID="btnRechazar" runat="server" Style="margin-left: 1%; margin-right: 1%; margin-top: 1%" Width="98%" class="btn btn-outline-danger" Text="Rechazar Reserva" OnClick="btnRechazar_Click" />
                    </div>
                </div>
                <div class="col-sm-12" style="margin-top: 1%; color:white; margin-bottom: 2%">
                    <h3 style="text-align: center;">Lista de Reparacion Pendientes</h3>
                    <asp:ListBox ID="lstReparacion" class="form-control" runat="server" OnSelectedIndexChanged="lstReparacion_Click" AutoPostBack="true" Height="310px" Style="border: 2px solid black"></asp:ListBox>
                </div>
            </div>
        </div>
    </div>
